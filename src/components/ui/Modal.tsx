      ...
      <div className="fixed inset-0 z-50 bg-black/45 backdrop-blur-sm" onClick={onClose}>
        ...
        >
          <div className="flex items-center justify-between border-b border-gray-100 px-4 py-4 sm:px-5">
            <h3 className="pr-3 text-lg font-semibold text-secondary-900">{title}</h3>
            <button
              type="button"
              className="inline-flex h-10 w-10 items-center justify-center rounded-full text-gray-500 transition hover:bg-gray-50 hover:text-gray-700"
              onClick={onClose}
              aria-label="Fermer"
            >
              <X size={18} />
