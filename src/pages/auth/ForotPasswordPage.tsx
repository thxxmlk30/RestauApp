        ...
        <div className="min-h-screen bg-gradient-to-br from-secondary-900 to-secondary-700 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="font-display text-3xl font-bold text-white">THE Mbaxxal</h1>
                </div>
                <div className="bg-white rounded-3xl p-8 shadow-2xl">
                    {!submitted ? (
                        <>
                            <Link to="/login" className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm mb-6">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 mt-6">
                                ...
                                <Button type="submit" variant="primary" size="lg" loading={loading} className="w-full">Envoyer le lien</Button>
                            </form>
                        </>
                    ) : (
                        <div className="text-center py-4">
                            ...
                            <Link to="/login">
                                <Button variant="outline" size="md" className="w-full">Retour à la connexion</Button>
                            </Link>
                        </div>
                    )}
                </div>
